-- View: tbcontentdeployed

-- DROP VIEW tbcontentdeployed;

CREATE OR REPLACE VIEW tbcontentdeployed AS 
 SELECT DISTINCT d.project,
  ...
  ORDER BY d.project, d.deploymentnumber, l.language, cp.contentpackage, cp."order";

ALTER TABLE tbcontentdeployed
  OWNER TO lb_data_uploader;
COMMENT ON VIEW tbcontentdeployed
  IS 'Content produced, categorized by the TB category under which it was deployed.';
